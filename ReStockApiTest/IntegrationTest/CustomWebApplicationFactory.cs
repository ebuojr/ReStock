        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    db.Stores.Add(new Store { No = 1, Name = "Test Store", Country = "Test Country", Address = "Test Address" });
                    db.Products.Add(new Product { ItemNo = "TEST999", Name = "Test Product", Brand = "BrandX", RetailPrice = 10.0m, IsActive = true });
                    db.InventoryThresholds.Add(new InventoryThreshold { StoreNo = 1, ItemNo = "TEST999", MinimumQuantity = 1, TargetQuantity = 5, ReorderQuantity = 2, LastUpdated = DateTime.UtcNow });
                    db.StoreInventories.Add(new StoreInventory { StoreNo = 1, ItemNo = "TEST999", Quantity = 10, LastUpdated = DateTime.UtcNow });
                    db.DistributionCenterInventories.Add(new DistributionCenterInventory { ItemNo = "TEST999", Quantity = 100, LastUpdated = DateTime.UtcNow });
                    ...
                    // Seed StoreInventory for StoreNo = 5090 and ItemNo = "TEST999" for CreateUpdateSalesOrder_Works test
                    db.StoreInventories.Add(new StoreInventory { StoreNo = 5090, ItemNo = "TEST999", Quantity = 10, LastUpdated = DateTime.UtcNow });
                    db.SaveChanges();
                }
            });
        }
